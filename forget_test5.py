...
from dataset import TextForgetDatasetQA_test5, dataset_to_json, custom_data_collator_forget
...
def main(cfg):
    ...
    torch_format_dataset = TextForgetDatasetQA_test5(tokenizer=tokenizer,
