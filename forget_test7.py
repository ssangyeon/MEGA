...
from dataset import TextForgetDatasetQA_test7, dataset_to_json, custom_data_collator_forget
...
def main(cfg):
    ...
    torch_format_dataset = TextForgetDatasetQA_test7(tokenizer=tokenizer,
