...
def get_result_dir(args):
    return f'results{"_WT_TEST" if (not args.use_LoRA) else ""}/tofu/llama2-7b/{args.forget}/{args.method}/seed_1001/epoch{args.epochs}_{args.lr}_FixRefFalse_maskTrue_1.0_1.0/1/unlearn_times_1'
